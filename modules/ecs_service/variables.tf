...
variable "slot" {
  description = "Deployment slot (blue or green). Appended to all resource names."
  type        = string
...
variable "app_name" {
  description = "App identifier, e.g. 'counter'. Namespaces resources alongside the banner service on the same cluster."
  type        = string
  default     = "app"
}
